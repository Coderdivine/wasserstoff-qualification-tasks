...
<div class="bg-[#fff] h-screen overflow-hidden flex items-center justify-center">
  <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
    <div class="p-12 md:p-24">
        <p  class="bg-white text-center text-slate-500 mx-4 mx-5 py-4 px-4 font-bold">Faynman Board</p>
      ...
      <button onClick={HandleLogin} class="bg-blue-400 from-gray-700 rounded-lg text-center to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full">Login</button>
    </div>                                
  </div>
 </div>
      </div>
